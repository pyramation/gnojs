...
export declare const PubKeyMultisig: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["K"], keyof Long>, never>);
        PubKeys?: {
            typeUrl?: string;
            value?: Uint8Array;
        }[] & ({
            ...
            typeUrl?: string;
            value?: Uint8Array;
        } & Record<Exclude<keyof I["PubKeys"][number], keyof Any>, never>)[] & Record<Exclude<keyof I["PubKeys"], keyof {
            typeUrl?: string;
            value?: Uint8Array;
        }[]>, never>;
    } & Record<Exclude<keyof I, keyof PubKeyMultisig>, never>>(object: I): PubKeyMultisig;
};
