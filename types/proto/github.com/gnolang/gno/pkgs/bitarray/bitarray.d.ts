...
export declare const BitArray: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["Bits"], keyof Long>, never>);
        Elems?: (string | number | Long)[] & (string | number | (Long & {
            ...
            toUnsigned: () => Long;
            xor: (other: string | number | Long) => Long;
        } & Record<Exclude<keyof I["Elems"][number], keyof Long>, never>))[] & Record<Exclude<keyof I["Elems"], keyof (string | number | Long)[]>, never>;
